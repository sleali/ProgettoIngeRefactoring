public class ControllerRepositoryN
{
    private RepositoryN repo;
    private ViewRepository viewR;

    public ControllerRepositoryN()
    {
        repo = new RepositoryN();
    }
    ...
    public String toString()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            viewR = new ViewReteN(repo.getRete(i));
            k = i + 1;
    ...
    public String visualizzaRete(int index)
    {
        ...
        ViewReteN view = new ViewReteN(r);
